...
public:
    ...
    double euclideanDistance(const Vec3& rhs) const noexcept
    {
    ...
    T manhattanDistance(const Vec3& rhs) const noexcept
    {
    ...
    friend Vec3<T> operator- (const Vec3<T>& vec) noexcept
    {
...
private:
    ...
    static T abs(param_type arg) noexcept
    {
        return arg >= 0 ? arg : -arg;
    }

    static T max(param_type arg1, param_type arg2) noexcept
    {
