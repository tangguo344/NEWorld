...
#undef OFFSETOF
    ...
    void ImGui_ImplSdl_NewFrame(SDL_Window *window)
    {
        ...
        io.DeltaTime = lastTime > 0.0 ? (float)(current_time - lastTime) : (float)(1.0f / 60.0f);
...
void imguiHelper::init(SDL_Window* window)
{
...
void imguiHelper::newFrame(SDL_Window* window)
{
    ImGui_ImplSdl_NewFrame(window);
}

bool imguiHelper::processEvent(SDL_Event* e)
{
